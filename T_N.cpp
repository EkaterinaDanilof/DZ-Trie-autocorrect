...
void getArrayNode(struct TrieNode* root, string currPrefix) // варианты дополнения текста по его части
{
    if (root->isEndOfWord)
...
int dysplayTextArrayNode(TrieNode* root, const string key) // выводит возможные варианты дополнения текста по его части
{
